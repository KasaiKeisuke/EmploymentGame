...
CScene* CScene::Create(MODE mode)
{
	...
	case MODE_CLEARRESULT:
		...
		// ガイド
		//******************************************
		CGuid::Create(D3DXVECTOR3(SCREEN_WIDTH / 2.0f + 400.0f, SCREEN_HEIGHT / 2.0f + 400.0f, 0.0f), 250.0f, 130.0f, CGuid::TEXTURETYPE::TYPE_RETURNTITLE);
	...
	case MODE_FAILRESULT:
		...
		// ガイド
		//******************************************
		CGuid::Create(D3DXVECTOR3(SCREEN_WIDTH / 2.0f, SCREEN_HEIGHT / 2.0f + 150.0f, 0.0f), 250.0f, 130.0f, CGuid::TEXTURETYPE::TYPE_RETURNTITLE);
